...
# for ALBERT:
# nohup bash search_petmlm_multisplit.sh boolq 0 albert >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh rte 1 albert >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh wic 2 albert >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh cb 3 albert >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh multirc 4 albert >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh wsc 5 albert >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh copa 6 albert >myout.file 2>&1 &

# for DeBERTa:
# nohup bash search_petmlm_multisplit.sh boolq 0 deberta >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh rte 1 deberta >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh wic 2 deberta >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh cb 3 deberta >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh multirc 4 deberta >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh wsc 5 deberta >myout.file 2>&1 &
# nohup bash search_petmlm_multisplit.sh copa 6 deberta >myout.file 2>&1 &
